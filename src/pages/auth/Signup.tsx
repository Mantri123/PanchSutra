...
const Signup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // *** THE FIX IS HERE ***
    // We create a clean object and handle optional fields correctly
    // by setting them to null if they are empty.
    const userData: any = {
      name: formData.name,
    ...
    if (formData.role === 'doctor') {
        ...
        userData.experience = formData.experience ? parseInt(formData.experience) : null;
        userData.specialization = formData.specialization ? formData.specialization.split(',').map(s => s.trim()) : null;
        userData.registrationNumber = formData.registrationNumber;
        userData.consultationFee = formData.consultationFee ? parseInt(formData.consultationFee) : null;
        userData.languages = formData.languages ? formData.languages.split(',').map(l => l.trim()) : null;
        userData.bio = formData.bio || null;
    }
